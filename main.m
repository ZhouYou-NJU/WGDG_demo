...
%%
%% Title                : Noise-robust lensless imaging based on Wirtinger gradient descent optimization
%% Authors              : You Zhou (zhouyou@nju.edu.cn), Xia Hua, Zibang Zhang and Xuemei Hu, Jingang Zhong, Guoan Zheng, Xun Cao
%% Authors' Affiliation : Nanjing University
%% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
clear; clc; close all;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% 
%% Parameters setting
D_LED2Mask            = 300e-3;                 % distance from LED matirx to pinhole mask (unit: m)
...
LEDBoard.xint         = 0;                      % X shift of center of LED matirx (unit: m)
LEDBoard.yint         = 0;                      % Y shift of center of LED matirx (unit: m)
LEDBoard.rotation     = 0;                      % rotation of LED matirx (unit: m)
% mismatched LED
LEDBoardm             = LEDBoard;
...
switch DataLabel
    case 'ID'                                                                               % ideal data       
        ...
        [ImgRecWGDG_ID] = getRec_WGDG(RawImgSet, LEDBoard, MainPara, Delta_g, DataLabel);   % WGDG algorithm
    case 'PD'                                                                               % data with Poisson noise
        [ImgRecGS_PD]  = getRec_GS (RawImgSetPo, LEDBoard, MainPara, DataLabel);            % GS algorithm
        [ImgRecWGDG_PD] = getRec_WGDG(RawImgSetPo, LEDBoard, MainPara, Delta_g, DataLabel); % WGDG algorithm
    case 'MD'                                                                               % data with mismatched LEDs
        [ImgRecGS_MD]  = getRec_GS (RawImgSetm, LEDBoard, MainPara, DataLabel);             % GS algorithm
        [ImgRecWGDG_MD] = getRec_WGDG(RawImgSetm, LEDBoard, MainPara, Delta_g, DataLabel);  % WGDG algorithm
    case 'GD'                                                                               % data with Gaussian noise
        ...
        [ImgRecWGDG_GD] = getRec_WGDG(RawImgSetGa, LEDBoard, MainPara, Delta_g, DataLabel); % WGDG algorithm
end  
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% 